...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'builder_userprofile', 'firstName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.lastName'
        db.add_column(u'builder_userprofile', 'lastName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'builder_userprofile', 'firstName')

        # Deleting field 'UserProfile.lastName'
        db.delete_column(u'builder_userprofile', 'lastName')
